(() => {
  ...
  const swedenProjection = [
    7.4, 7.6, 7.3, 7.2, 7.2, 7.2, 7.1, 7.0, 6.8, 6.8, 6.7, 6.7, 6.7, 6.7, 6.7,
    6.8, 6.7, 6.8, 6.9, 7.0, 7.1, 7.2, 7.2, 7.2, 7.2,
  ];
  const spainProjection = [
    13.1, 13.4, 13.5, 13.7, 13.9, 14.2, 14.6, 15.0, 15.4, 15.8, 16.0, 16.2,
    16.5, 16.7, 16.9, 17.0, 17.0, 16.9, 16.8, 16.8, 16.7, 16.6, 16.6, 16.6,
    16.7,
  ];
  ...
  const baseMeta = {
    ...
    sourceUrl:
      "https://hesperides.edu.es/documentos_pdf/Sistemas_de_pensiones_comparados.pdf",
  ...
  const chartByNumber = {
    1: {
      title:
        "Grafica 1. Suecia estabiliza el gasto en pensiones mientras en Espana se dispara",
      subtitle:
        "Gasto en pensiones publicas en Espana y Suecia, en porcentaje de PIB",
      type: "line",
      unit: "%",
      x: years1981To2021,
      ...
      series: [
        {
          ...
          type: "line",
          data: [
            6.2, 6.3, 6.5, 6.8, 7.1, 7.4, 7.3, 7.2, 7.2, 7.9, 8.0, 8.8, 8.8,
            8.9, 9.1, 9.0, 8.7, 8.6, 8.3, 8.1, 8.0, 8.1, 8.0, 8.0, 7.9, 8.1,
            8.4, 9.8, 10.5, 11.2, 11.8, 11.5, 11.5, 11.3, 11.6, 12.5, 13.2,
            12.9, 12.6, 12.4, 12.7,
          ],
          color: "#f3c400",
        },
        {
          ...
          type: "line",
          data: [
            6.5, 6.6, 6.5, 6.6, 6.7, 6.8, 6.8, 6.8, 6.8, 6.8, 7.0, 8.1, 7.9,
            7.6, 7.6, 7.4, 7.2, 7.1, 6.9, 6.7, 6.5, 6.6, 6.7, 6.6, 6.4, 6.2,
            6.8, 7.7, 7.3, 7.2, 7.8, 8.0, 7.8, 7.8, 7.8, 7.8, 7.8, 7.5, 7.9,
            7.5, 7.5,
          ],
          color: "#7f5b00",
        },
    ...
    2: {
      title:
        "Grafica 2. Se espera que el modelo sueco mantenga estable el gasto en pensiones",
      subtitle:
        "Gasto en pensiones publicas previsto en Espana y Suecia, en porcentaje de PIB",
      type: "line",
      unit: "%",
      ...
      series: [
        ...
        },
        {
          ...
          type: "line",
          data: spainProjection.map((value, index) =>
            Number((value - swedenProjection[index]).toFixed(2)),
          ),
    ...
    3: {
      title:
        "Grafica 3. Suecia realizo su reforma del sistema de pensiones con una poblacion envejecida",
      subtitle:
        "Evolucion de la ratio de dependencia de los mayores en Espana y Suecia",
      type: "line",
      unit: "%",
      x: years1980To2024,
      ...
      series: [
        {
          ...
          type: "line",
          data: [
            25.3, 25.5, 25.8, 26.0, 26.3, 26.8, 27.2, 27.5, 27.7, 27.8, 27.8,
            27.7, 27.7, 27.6, 27.5, 27.4, 27.4, 27.3, 27.2, 26.9, 26.8, 26.6,
            26.5, 26.5, 26.6, 27.0, 27.5, 28.3, 29.5, 30.8, 31.6, 32.0, 32.1,
            32.2, 32.3, 32.4, 32.5, 32.6, 32.8, 32.9, 33.0, 33.1, 33.1, 33.1,
            33.1,
          ],
          color: "#7f5b00",
        },
        {
          ...
          type: "line",
          data: [
            17.6, 17.8, 17.9, 18.1, 18.3, 18.5, 19.0, 19.5, 20.2, 20.8, 21.3,
            21.8, 22.5, 23.1, 23.8, 24.4, 25.0, 24.8, 24.2, 24.5, 24.3, 24.0,
            24.2, 24.6, 25.4, 26.0, 27.2, 28.1, 28.7, 29.2, 29.6, 29.8, 30.1,
            30.3, 30.5, 30.6, 30.7, 30.8, 30.8, 30.8, 30.8, 30.8, 30.8, 30.8,
            30.8,
          ],
          color: "#f3c400",
        },
    ...
    4: {
      title:
        "Grafica 4. El modelo sueco controla la deuda publica, el modelo espanol la dispara",
      subtitle:
        "Evolucion de la deuda publica en Espana y Suecia, en porcentaje de PIB",
      type: "line",
      unit: "%",
      x: years1980To2023,
      eventLines: [{ x: "1992", label: "Inicio diseno reforma sueca (1992)" }],
      series: [
        {
          ...
          type: "line",
          data: [
            16.1, 18.0, 20.5, 23.0, 26.0, 29.0, 31.0, 31.0, 30.0, 29.0, 30.0,
            32.0, 40.0, 45.0, 47.0, 47.0, 46.0, 45.0, 43.0, 41.0, 39.0, 37.0,
            35.0, 33.0, 31.0, 30.0, 32.0, 36.0, 42.0, 50.0, 65.0, 85.0, 92.0,
            95.0, 94.0, 93.0, 92.0, 91.0, 90.0, 89.0, 88.0, 106.0, 103.0, 105.0,
          ],
          color: "#f3c400",
        },
        {
          ...
          type: "line",
          data: [
            39.8, 44.0, 48.0, 50.0, 50.0, 50.0, 47.0, 44.0, 43.0, 42.0, 44.0,
            51.0, 54.0, 55.0, 55.0, 54.0, 52.0, 51.0, 49.0, 48.0, 49.0, 48.0,
            47.0, 46.0, 45.0, 43.0, 42.0, 42.0, 43.0, 44.0, 45.0, 45.0, 44.0,
            43.0, 43.0, 42.0, 41.0, 40.0, 41.0, 42.0, 40.0, 39.0, 38.0, 36.4,
          ],
          color: "#7f5b00",
        },
      ],
    ...
    5: {
      title:
        "Grafica 5. Los jubilados en Suecia dependen menos de las transferencias del Estado que en Espana",
      subtitle:
        "Fuente de ingresos de las personas de mas de 65 anos, en porcentaje del ingreso bruto equivalente total",
      unit: "%",
      x: [
        "Transferencias Estado",
        "Planes privados y capital",
        "Ingreso trabajo",
      ],
    ...
    6: {
      title:
        "Grafica 6. Los activos del sistema de pensiones de Suecia son superiores a sus obligaciones",
      subtitle:
        "Evolucion del indice de equilibrio del sistema de pensiones sueco",
      type: "line",
      unit: "indice",
      yAxisDecimals: 2,
      tooltipDecimals: 2,
      ...
      series: [
        {
          ...
          type: "line",
          data: [
            1.0, 1.0, 1.01, 0.99, 0.96, 0.95, 1.01, 1.02, 0.98, 1.01, 1.05,
            1.02, 1.04, 1.03, 1.05, 1.08, 1.08, 1.12, 1.13, 1.12, 1.17,
          ],
          color: "#f3c400",
    ...
    7: {
      title:
        "Grafica 7. Espana ofrece pensiones mas generosas para rentas bajas y medias, Suecia para las altas",
      subtitle:
        "Tasa de sustitucion neta para diferentes porcentajes de salario medio (ano 2022)",
      unit: "%",
      barBorderRadius: false,
    ...
    8: {
      title:
        "Grafica 8. La pobreza en la vejez es mas elevada en Espana que en Suecia pese a tener pensiones mas generosas",
      subtitle:
        "Porcentaje de poblacion por cohortes de edad con renta disponible inferior al 50% de la mediana nacional (ano 2022)",
      unit: "%",
      barBorderRadius: false,
    ...
    9: {
      title:
        "Grafica 9. El esfuerzo fiscal del sistema chileno de pensiones es reducido",
    ...
    10: {
      title:
        "Grafica 10. El sistema de pensiones chileno ha ganado sostenibilidad con los anos",
      subtitle:
        "Pago en pensiones (% PIB) sobre poblacion anciana (% poblacion total)",
    ...
    11: {
      title:
        "Grafica 11. Los trabajadores chilenos realizan un esfuerzo pequeno en el pago de sus pensiones",
      subtitle:
        "Contribuciones obligatorias para el pago de pensiones (empleado y empleador)",
      unit: "%",
      x: ["Chile", "Espana"],
      barBorderRadius: false,
      showLegend: false,
    ...
    12: {
      title:
        "Grafica 12. Chile ha acumulado activos que respaldan la jubilacion de sus pensionistas",
    ...
    13: {
      title:
        "Grafica 13. La tasa de empleo de los mayores de 65 anos en Chile es elevada, en Espana es de las mas bajas del mundo",
    ...
    14: {
      ...
      subtitle:
        "Ingreso de los jubilados por fuente (porcentaje sobre el total)",
      unit: "%",
      x: ["Chile", "OCDE", "Espana"],
      stack: "g14",
      barBorderRadius: false,
    ...
    15: {
      title:
        "Grafica 15. Chile desarrollo un mercado de capitales desde la creacion del sistema de pensiones de capitalizacion",
    ...
    16: {
      ...
      subtitle:
        "PIB per capita de Chile y America Latina y el Caribe (1960-2024)",
      type: "line",
      yAxisType: "log",
      unit: "indice",
    ...
    17: {
      title:
        "Grafica 17. Casi la mitad de los activos del sistema de pensiones chileno se encuentran en el exterior",
      subtitle:
        "Porcentaje de activos del sistema de pensiones chileno emitidos en el exterior",
      type: "line",
      unit: "%",
      showLegend: false,
      ...
      series: [
        {
          ...
          smooth: false,
          data: [
            16, 24, 27, 30, 32, 35, 29, 44, 45, 37, 39, 43, 44, 44.5, 39, 43,
            42, 44, 46, 54, 41, 45.3,
          ],
          color: "#f3c400",
          areaStyle: { color: "rgba(243, 196, 0, 0.18)" },
    ...
    18: {
      ...
      subtitle:
        "Tasa de reemplazo del sistema de pensiones para diferentes salarios (ano 2022)",
      unit: "%",
      barBorderRadius: false,
    ...
    19: {
      title:
        "Grafica 19. El ingreso de los jubilados chilenos es superior al de otros paises desarrollados",
      subtitle:
        "Ingreso de los mayores de 65 anos como porcentaje del ingreso del resto de la poblacion",
      unit: "%",
      showLegend: false,
      barBorderRadius: false,
      x: ["Espana", "Chile", "OCDE"],
    ...
    20: {
      title:
        "Grafica 20. Los jubilados alemanes tienen una distribucion de ingresos similar a la de los espanoles",
      subtitle:
        "Fuente de ingresos de las personas de mas de 65 anos en Alemania y Espana, en porcentaje del ingreso bruto equivalente",
      unit: "%",
      x: [
        "Transferencias Estado",
        "Planes privados y capital",
    ...
    21: {
      title:
        "Grafica 21. Alemania incentiva las pensiones privadas con deducciones fiscales",
      subtitle:
        "Deducciones fiscales en el sistema privado de pensiones en terminos de salario medio",
    ...
    22: {
      title:
        "Grafica 22. Alemania estabiliza el porcentaje de gasto en pensiones, Espana lo dispara",
      subtitle: "Gasto en pensiones publicas, en porcentaje del PIB",
      type: "line",
      unit: "%",
      showLegend: false,
    ...
    24: {
      title:
        "Grafica 24. La pension publica en Alemania ha caido hasta el 48% del salario de los trabajadores",
      subtitle:
        "Nivel de pension neto antes de impuestos para los antiguos Bundeslander (1977-2024)",
      type: "line",
      unit: "%",
    ...
    25: {
      title:
        "Grafica 25. La cotizacion con destino a la pension publica es superior en Espana que en Alemania",
      subtitle:
        "Comparativa de cotizaciones sociales destinadas al primer pilar de la pension en Espana y Alemania (antes/despues de la ultima reforma de cada pais)",
      renderAs: "small-multiples",
    ...
    26: {
      title:
        "Grafica 26. Acumulacion esperada de activos del fondo soberano de pensiones de Alemania",
      subtitle:
        "Expectativa de acumulacion bajo diferentes escenarios de rentabilidad de la inversion",
      type: "line",
      unit: "m",
      x: years2024To2036,
      showLegend: true,
      ...
      series: [
        {
          ...
          symbol: "none",
          data: [
            12000, 20000, 30000, 60000, 75000, 90000, 105000, 120000, 135000,
            155000, 175000, 195000, 220000,
          ],
          color: "#ecd869",
        ...
        },
        {
          ...
          symbol: "none",
          data: [
            0, 0, 0, 0, 2000, 4000, 7000, 10000, 14000, 18000, 22000, 26000,
            30000,
          ],
          color: "#b9aa86",
        ...
        },
        {
          ...
          symbol: "none",
          data: [
            0, 0, 0, 0, 3000, 6000, 9000, 13000, 17000, 22000, 27000, 33000,
            40000,
          ],
          color: "#c8b068",
    ...
    27: {
      title:
        "Grafica 27. El bajo coste de financiacion de Alemania puede justificar la creacion del fondo soberano de pensiones",
      subtitle:
        "Rendimiento real de los fondos de pensiones de Suecia y de Chile y rentabilidad real del bono aleman a 10 anos",
      unit: "%",
      showLegend: false,
      barBorderRadius: false,
      x: [
        "Rentabilidad fondos Suecia (2000-2024)",
        "Rentabilidad fondos Chile (1981-2024)",
        "Coste financiacion Alemania (TYD tipo real)",
      ],
      series: [
        {
          name: "Rentabilidad",
    ...
    28: {
      title:
        "Grafica 28. El fondo de pensiones aleman sera completamente insuficiente para cubrir las pensiones",
      subtitle:
        "Rendimiento esperado del fondo y gasto en pensiones publicas de Alemania",
      unit: "m",
      showLegend: false,
      barBorderRadius: false,
      x: [
        "Gasto pensiones publicas (ano 2035)",
        "Gasto pensiones publicas (ano 2025)",
        "Rendimiento anual fondo (ano 2035)",
      ],
      series: [
        {
    ...
    29: {
      title:
        "Grafica 29. Alemania no deja de incrementar las subvenciones federales al sistema de pensiones",
      subtitle:
        "Subvenciones federales al regimen general de pensiones, millones de euros de 2020",
      type: "line",
      unit: "m",
      x: years1960To2024,
      stack: "g29",
    ...
    30: {
      title:
        "Grafica 30. El 25% del gasto en pensiones en Alemania esta financiado con presupuestos generales del Estado",
      subtitle:
        "Subvenciones federales, en porcentaje de los ingresos totales del seguro de pensiones (RV)",
      type: "line",
      unit: "%",
      x: years1991To2024,
      showLegend: false,
    ...
    31: {
      title:
        "Grafica 31. El envejecimiento de la poblacion pone en peligro el sistema de pensiones de reparto",
      subtitle:
        "Personas en edad de trabajar sobre poblacion de mas de 65 anos (paises de la UE, 1960-2024)",
      type: "line",
      unit: "indice",
      x: years1960To2024,
      showLegend: false,
    ...
    32: {
      title:
        "Grafica 32. Espana realiza el mayor esfuerzo publico en pensiones de entre los paises comparados",
      subtitle:
        "Gasto publico en pensiones por pensionista en relacion al PIB por habitante",
      unit: "%",
  ...
  const table1 = {
    ...baseMeta,
    title:
      "Tabla 1. El blindaje de la jubilacion en Alemania equivale a un incremento del 6% del IVA",
    subtitle:
      "Comparativa de estimaciones con y sin blindaje de acuerdo al Deutsche Bundesbank",
    renderAs: "table",
    tableColumns: [
      "Indicador (2070)",
      "Legislacion actual",
  ...
  const table2 = {
    ...baseMeta,
    title:
      "Tabla 2. Espana, Alemania, Suecia y Chile muestran modelos distintos de apoyo al ahorro previsional",
    subtitle:
      "Comparativa de limites, beneficios y mecanismos fiscales en los pilares 2 (empresa) y 3 (privado)",
    renderAs: "table",
    tableColumns: [
      "Pais",
      "Pilar 2 (Planes de empresa)",
      "Pilar 3 (Planes privados / Ahorro individual)",
    ],
    tableRows: [
      [
        "Espana",
  ...
  window.REPORT_DATA = {
    meta: {
      ...
      lead: "Version interactiva del informe con comparativas visuales reconstruidas para evaluar sostenibilidad, incentivos y resultados entre modelos.",
      reportUrl:
        "https://hesperides.edu.es/informes/sistemas_de_pensiones_comparados",
      pdfUrl:
        "https://hesperides.edu.es/documentos_pdf/Sistemas_de_pensiones_comparados.pdf",
      caveat:
      ...
      keyFinding: {
        kpi: "13,2% PIB",
        text: "Gasto en pensiones de Espana — el mayor esfuerzo publico de la UE",
      },
      contentBadge: "32 graficos · 2 tablas",
    },
    metrics: [
      { kpi: "13,2%", label: "Gasto en pensiones sobre PIB (Espana)" },
      { kpi: "7,4%", label: "Gasto en pensiones sobre PIB (Suecia)" },
      { kpi: "10,3%", label: "Gasto en pensiones sobre PIB (Alemania)" },
      { kpi: "4", label: "Paises comparados: ES, SE, DE, CL" },
    ],
    chapters: [
      ...
      },
      {
        id: "sec-3",
        title:
          "3. El modelo sueco: sostenibilidad y confianza intergeneracional",
      ...
      {
        id: "sec-6",
        title: "6. Una problemática común",
        charts: makeIds("f", 32, 33),
      },
    ...
    playgrounds: [
      {
        ...
        compute: (state, h) => {
          const mixRatio = h.clamp(
            (state.cobertura_complementaria - 26) / 39,
            0,
            1,
          );
          ...
          return {
            kpis: [
              {
                value: `${h.formatNumber(gasto2035, 2)}%`,
                desc: "Gasto en pensiones estimado en 2035",
              },
              {
                value: `${h.formatNumber(brechaFiscal, 2)}% PIB`,
                desc: "Brecha fiscal estimada",
              },
              {
                value: `${h.formatNumber(cotizacionNecesaria, 2)}%`,
                desc: "Tipo contributivo requerido",
              },
              {
                value: `${h.formatNumber(tension, 1)}`,
                desc: "Indice sintetico de tension (100 = alta)",
                color,
              },
            ],
            thermometer: {
            ...
            narrative: narrativa,
            note: "Modelo orientativo: no sustituye una proyeccion actuarial completa y usa coeficientes calibrados con las graficas del informe.",
          };
        },
      },
      {
        ...
        compute: (state, h) => {
          ...
          const diversificacion = h.clamp(
            state.peso_privado + (state.cobertura - 26) * 0.25,
            8,
            65,
          );
          ...
          return {
            kpis: [
              {
                value: `${h.formatNumber(reemplazoTotal, 2)}%`,
                desc: "Tasa de reemplazo total estimada",
              },
              {
                value: `${h.formatNumber(riesgoPobreza, 2)}%`,
                desc: "Riesgo de pobreza relativa 65+",
                color,
              },
              {
                value: `${h.formatNumber(diversificacion, 1)}%`,
                desc: "Diversificacion de ingresos no publicos",
              },
              {
                value: `${h.formatNumber(colchon, 1)} p.p.`,
                desc: "Colchon sobre umbral 60% de reemplazo",
              },
            ],
            thermometer: {
              value: robustez,
            ...
            narrative: narrativa,
            note: "La estimacion usa coeficientes simplificados para mantener coherencia visual con el informe comparado.",
          };
        },
      },
    ],
