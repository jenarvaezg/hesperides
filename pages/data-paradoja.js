(() => {
  const legacy = {
    ...
    tables: {
      ...
      t2: {
        ...
        rows: [
          ...
          [
            "5. Proyecto y licencia de edificación",
            "Redacción: 3 meses; aprobación: 6 a 12 meses",
          ],
    ...
    charts: {
      g1: {
        id: "g1",
        title:
          "Gráfico 1. La vivienda es el principal problema de los españoles",
        ...
        series: [
          {
            ...
            type: "bar",
            data: [
              37.1, 20.5, 18.3, 16.9, 15.7, 14.3, 13.7, 13.4, 13.2, 12.7, 12.6,
            ],
            color: "#f3c400",
          },
        ],
      ...
      g2: {
        ...
        subtitle:
          "Cambio en el precio de la vivienda (dic-2020 a jun-2025) e IPC",
        ...
        series: [
          {
            ...
            type: "bar",
            data: [
              49.7, 46.7, 46.6, 45.3, 44.6, 44.5, 44.3, 43.2, 42.2, 41.8, 41.6,
              40.7, 40.0, 39.5, 38.5, 37.6, 31.3, 30.9, 21.2,
            ],
            color: "#f3c400",
          },
        ],
        ...
        series: [
          {
            ...
            type: "line",
            data: [
              5.2, 5.1, 6.3, 7.1, 6.8, 7.9, 10.2, 11.7, 12.8, 12.4, 12.1, 12.8,
              14.7, 15.6, 16.0, 19.7, 14.0, 5.0, 2.4, 1.8, 1.4, 1.0, 0.4, 0.4,
              0.6, 1.0, 1.3, 1.6, 1.8, 1.5, 1.8, 2.0, 2.7,
            ],
            color: "#7f5b00",
            areaStyle: true,
          },
        ...
        series: [
          {
            ...
            type: "line",
            data: [
              14.5, 14.0, 13.8, 14.6, 15.8, 16.4, 17.0, 17.8, 18.5, 19.3, 20.2,
              21.2, 20.4, 18.8, 16.0, 14.5, 13.0, 11.5, 10.0, 9.0, 9.2, 9.0,
              9.3, 10.0, 11.2, 11.0, 10.8, 10.6, 10.9, 10.7, 10.9,
            ],
            color: "#f3c400",
            areaStyle: true,
          },
          {
            ...
            type: "line",
            data: [
              6.0, 6.5, 6.2, 6.8, 7.4, 8.0, 8.7, 9.1, 9.8, 10.5, 11.2, 12.4,
              11.5, 8.8, 7.0, 5.8, 4.9, 4.3, 3.8, 3.9, 4.2, 4.5, 4.9, 5.3, 5.8,
              6.0, 5.7, 5.4, 5.6, 5.5, 5.6,
            ],
            color: "#7f5b00",
            areaStyle: true,
          },
        ...
        series: [
          {
            ...
            type: "line",
            data: [
              -1.5, -0.8, 1.1, 3.0, 3.4, 2.4, 2.3, 3.0, 3.0, 3.4, 3.5, 3.5, 2.6,
              1.2, 0.8, 1.1, 0.2, -0.2, 0.2, 0.7, 1.4, 2.1, 2.6, 2.9, 3.3, 1.7,
              2.0, 2.6, 2.5, 2.7,
            ],
            color: "#f3c400",
          },
          {
            ...
            type: "line",
            data: [
              -3.0, -3.0, -1.0, 1.5, 3.2, 3.7, 4.3, 4.6, 4.4, 4.3, 4.1, 4.2,
              1.2, -2.1, -2.1, -3.6, -5.2, -6.2, -5.8, -3.6, -3.2, -2.8, -2.3,
              -1.1, -0.3, -0.3, -0.3, 0.2, -0.2, -0.1,
            ],
            color: "#2b2b2b",
          },
        ],
        ...
        series: [
          {
            ...
            type: "line",
            data: [
              31, 22, 22, 27, 41, 53, 69, 67, 70, 63, 63, 61, 41, 30, 31, 8, 5,
              4, 3, 3, 3, 3, 3, 1, 3, 25, 14, 12, 8, 12.8,
            ],
            color: "#7f5b00",
            areaStyle: true,
          },
      ...
      g8: {
        ...
        subtitle:
          "Porcentaje del suelo según posibilidad de construir vivienda",
        unit: "%",
        exactness: "exacta del gráfico",
        ...
        series: [
          {
            ...
            type: "bar",
            data: [
              87.4, 86.5, 83.2, 80.4, 79.6, 78.9, 78.4, 73.7, 71.9, 71.8, 70.3,
              69.4, 64.7, 64.3, 58.8, 57.0, 56.9,
            ],
            color: "#f3c400",
          },
        ],
        ...
        series: [
          {
            ...
            type: "line",
            data: [
              900, 905, 898, 892, 897, 878, 900, 940, 957, 1065, 1075, 1090,
              1110, 1118, 1125, 1135, 1130, 1130, 1128, 1124, 1119, 1135, 1210,
              1290, 1323,
            ],
            color: "#f3c400",
          },
      ...
      g13: {
        ...
        subtitle:
          "Evolución del PIB por hora trabajada (euros constantes 2021)",
        unit: "€/hora",
        exactness: "reconstruida visualmente",
        ...
        series: [
          {
            ...
            type: "line",
            data: [
              32.28, 32.6, 32.7, 32.6, 32.5, 32.4, 32.5, 32.5, 32.5, 32.6, 32.7,
              32.9, 33.3, 33.4, 34.0, 35.2, 35.6, 36.0, 36.5, 36.8, 37.2, 37.3,
              37.5, 37.7, 37.9, 37.9, 37.9, 38.0, 37.9, 38.2, 38.44,
            ],
            color: "#7f5b00",
          },
          {
            ...
            type: "line",
            data: [
              29.28, 29.0, 27.0, 26.5, 25.8, 25.0, 24.8, 25.0, 25.1, 25.1, 25.2,
              25.3, 25.6, 24.8, 28.0, 32.0, 31.0, 30.5, 32.0, 31.1, 31.4, 30.8,
              31.2, 31.0, 29.8, 29.5, 29.3, 27.2, 27.5, 27.0, 26.24,
            ],
            color: "#f3c400",
          },
        ],
      ...
      g14: {
        ...
        subtitle:
          "Distribución de trabajadores por tamaño de empresa (oct-2025)",
        unit: "%",
        exactness: "exacta del gráfico",
        ...
        series: [
          {
            ...
            type: "line",
            data: [
              9.3, 9.8, 9.4, 10.1, 10.8, 11.2, 11.6, 11.9, 12.0, 12.4, 12.3,
              12.8, 13.2, 12.8, 10.5, 9.4, 8.0, 6.6, 5.8, 5.56, 5.9, 6.1, 6.0,
              6.3, 6.2, 6.5, 6.4, 6.7, 6.96,
            ],
            color: "#f3c400",
            areaStyle: true,
          },
        ...
        series: [
          {
            ...
            type: "line",
            data: [
              5.3, 2.0, 10.0, 4.0, 6.0, 5.0, 8.0, 7.0, 6.0, 12.0, 8.0, 9.0, 7.0,
              11.0, 8.0, 13.0, 12.0, 6.0, 12.0, 7.0, 20.8,
            ],
            color: "#f3c400",
          },
          {
            ...
            type: "line",
            data: [
              0.0, 0.0, 3.0, 1.0, 2.0, 0.0, 0.0, 0.0, 0.0, 3.0, 5.0, 4.0, 4.0,
              6.0, 4.0, 5.0, 4.0, 4.0, 4.5, 0.0, 2.6,
            ],
            color: "#7f5b00",
          },
        ],
        ...
        series: [
          {
            ...
            type: "line",
            data: [
              100.0, 103.0, 105.5, 107.0, 108.3, 109.5, 113.0, 113.0, 112.0,
              111.2, 111.7, 112.4, 109.8, 112.5, 110.0, 110.3, 111.5,
            ],
            color: "#7f5b00",
          },
          {
            ...
            type: "line",
            data: [
              100.0, 105.0, 107.0, 109.8, 111.0, 111.1, 111.8, 111.0, 109.0,
              106.6, 106.7, 107.0, 105.0, 105.0, 105.5, 103.0, 100.8,
            ],
            color: "#f3c400",
          },
        ],
        ...
        series: [
          {
            ...
            type: "line",
            data: [
              100, 110, 115, 125, 140, 135, 180, 172, 145, 150, 140, 155, 172,
              140, 145, 146.6,
            ],
            color: "#7f5b00",
          },
          {
            ...
            type: "line",
            data: [
              100, 102, 104, 106, 110, 112, 120, 123, 124, 125, 140, 142, 141,
              142, 143, 143.2,
            ],
            color: "#2b2b2b",
          },
          {
            ...
            type: "line",
            data: [
              100, 108, 120, 136, 142, 156, 172, 162, 150, 145, 141, 138, 132,
              130, 138, 140.9,
            ],
            color: "#f3c400",
          },
          {
            ...
            type: "line",
            data: [
              100, 105, 108, 110, 112, 118, 121, 123, 124, 124, 125, 125, 126,
              125, 125, 124.7,
            ],
            color: "#907b3b",
          },
  ...
  const blockedAverage = blockedSeries.length
    ? blockedSeries.reduce((acc, value) => acc + value, 0) /
      blockedSeries.length
    : 0;

  const chartsBySectionId = Object.fromEntries(
    (legacy.sections || []).map((section) => [
      section.id,
      Array.isArray(section.chartIds) ? [...section.chartIds] : [],
    ]),
  );
  ...
  const chapters = [
    ...
    { id: "introduccion", title: "1. Introducción", charts: [] },
    {
      id: "s1",
      title: "1. La principal preocupación",
      charts: chartsBySectionId.s1 || [],
    },
    {
      id: "s2",
      title: "2. El precio de la vivienda se dispara",
      charts: chartsBySectionId.s2 || [],
    },
    {
      id: "s3",
      title: "3. Precio, rentabilidad y oferta de vivienda",
      charts: chartsBySectionId.s3 || [],
    },
    {
      id: "s4",
    ...
    },
    {
      id: "s5",
      title: "5. Regulación del producto vivienda",
      charts: chartsBySectionId.s5 || [],
    },
    {
      id: "s6",
      title: "6. Dinámicas internas del sector",
      charts: chartsBySectionId.s6 || [],
    },
  ...
  window.REPORT_DATA = {
    meta: {
      ...
      lead: "Una lectura vertical del informe, con todos los graficos navegables y dos playgrounds para experimentar con rentabilidad, suelo desbloqueado y plazos regulatorios.",
      reportUrl,
      pdfUrl,
      caveat:
        legacy.meta?.caveat ||
      ...
      keyFinding: {
        kpi: "95,7%",
        text: "Del suelo espanol no esta disponible para construir vivienda",
      },
      contentBadge: "18 graficos",
    },
    metrics: [
      {
    ...
    text: {
      ...
      ranges: [
        ...
        },
        {
          chapterId: "s4",
          start:
            "4. La escasez artificial del suelo y edificabilidad disponible",
    ...
    playgrounds: [
      {
        ...
        compute: (state, h) => {
          ...
          const financeCost =
            productionCost * (financeRate / 100) * (delayYears / 2);
          ...
          return {
            kpis: [
              {
                value: `${h.formatNumber(netMargin)}%`,
                desc: "Margen neto estimado",
              },
              {
                value: `${h.formatInt(Math.round(netProfitPerM2))} EUR/m²`,
                desc: "Resultado neto por m²",
              },
              {
                value: `${h.formatNumber(realPriceGap)} p.p.`,
                desc: "Precio vivienda menos IPC",
              },
              {
                value: `${h.formatNumber(expectedStarts)} / 1.000`,
      ...
      },
      {
        ...
        compute: (state, h) => {
          ...
          const executableTarget =
            totalPotential * (1 - state.blocked_target / 100);
          ...
          const baselineAnnualStarts =
            (state.population_millions * 1_000_000 * baselineStartsPer1000) /
            1000;
          const impactVsBaseline = (annualImpact / baselineAnnualStarts) * 100;

          const color =
            deltaUnits >= 0 ? "var(--status-good)" : "var(--status-bad)";
          const narrative =
            deltaUnits >= 0
          ...
          return {
            kpis: [
              ...
              {
                value: `${h.formatInt(Math.round(annualImpact))}/ano`,
                desc: "Ritmo anual durante maduracion",
              },
              {
                value: h.formatInt(Math.round(executableNow)),
                desc: "Viviendas ejecutables hoy",
              },
              {
                value: `${h.formatNumber(impactVsBaseline)}%`,
                desc: "Impacto anual vs inicios actuales",
              },
            ],
            thermometer: {
