(() => {
  ...
  const charts = {
    f01: {
      title:
        "Tabla 1. Impacto de una generacion muy numerosa en la tasa de dependencia de un pais",
      subtitle:
        "Fases vitales de la nueva generacion y su transicion demografica",
      source:
        "El dia D de las pensiones ha llegado (2025) · Elaboracion propia",
      sourceUrl:
        "https://hesperides.edu.es/documentos_pdf/Informe_dia_D_pensiones.pdf",
      exactness: "exacta del informe",
      renderAs: "table",
      tableHighlightFirstRow: false,
      tableColumns: [
        "Fases vitales nueva generacion",
        "Fases transicion demografica",
      ],
      tableRows: [
    ...
    f02: {
      title:
        "Grafico 1. La natalidad espanola no alcanza el umbral de reemplazo generacional desde 1980",
      subtitle:
        "Tasa de fertilidad vs. tasa de reemplazo en Espana (1975-2023)",
      ...
      series: [
        {
          ...
          type: "line",
          data: [
            2.77, 2.5, 2.1, 1.8, 1.6, 1.35, 1.19, 1.18, 1.27, 1.45, 1.32, 1.24,
            1.12,
          ],
          color: "#f3c400",
    ...
    f03: {
      title:
        "Grafico 2. La emigracion de espanoles se frena en los anos 80s y se invierte en los anos 90s",
    ...
    f04: {
      title:
        "Grafico 3. Las nuevas generaciones de espanoles son mucho menos numerosas que las anteriores",
      subtitle:
        "Personas (millones) por generacion a lo largo de su ciclo vital",
      source: "El dia D de las pensiones ha llegado (2025)",
      sourceUrl:
        "https://hesperides.edu.es/documentos_pdf/Informe_dia_D_pensiones.pdf",
      exactness: "reconstruida visualmente",
    ...
    f05: {
      title:
        "Grafico 4. El gran reto demografico espanol: 3,25 personas en edad laboral por cada anciano",
      subtitle:
        "Ratio de personas entre 15 y 64 anos sobre personas mayores de 65 anos en Espana (1962-2024)",
      source: "El dia D de las pensiones ha llegado (2025)",
      sourceUrl:
        "https://hesperides.edu.es/documentos_pdf/Informe_dia_D_pensiones.pdf",
      exactness: "reconstruida visualmente",
    ...
    f06: {
      title:
        "Tabla 2. La Seguridad Social nacio en el ano 1967 y provoco que las personas se jubilaran antes",
      subtitle:
        "Edad de entrada y salida de la vida activa en 1960 y 1970 en Espana (anos)",
      source: "El dia D de las pensiones ha llegado (2025)",
      sourceUrl:
        "https://hesperides.edu.es/documentos_pdf/Informe_dia_D_pensiones.pdf",
      exactness: "exacta del informe",
    ...
    f07: {
      title:
        "Grafico 5. La esperanza de vida a los 65 anos se dispara en Espana",
      ...
      series: [
        {
          ...
          type: "line",
          data: [
            15.2, 15.5, 15.9, 16.2, 16.7, 16.8, 17.2, 17.4, 17.5, 17.9, 18.1,
            18.3, 18.4, 18.9, 19.1, 19.0, 19.7, 20.0, 20.3, 20.7, 20.9, 21.2,
            21.0, 20.4, 21.1, 21.1, 21.7,
          ],
          color: "#f3c400",
          smooth: false,
          symbolSize: 5,
    ...
    f08: {
      title:
        "Grafico 6. El bono demografico en Espana tuvo lugar entre los anos 1985 y 2015",
      ...
      series: [
        {
          ...
          type: "line",
          data: [
            55.5, 55.8, 56.2, 56.8, 57.5, 58.5, 59.4, 60.0, 60.2, 60.3, 59.6,
            58.0, 56.5, 54.8, 53.2, 51.6, 50.3, 49.0, 47.8, 46.8, 46.1, 45.8,
            45.6, 45.8, 46.0, 45.7, 45.2, 45.4, 46.8, 49.0, 50.4, 51.3, 51.1,
          ],
          color: "#f3c400",
          smooth: false,
          symbolSize: 5,
    ...
    f09: {
      title:
        "Grafico 7. El crecimiento economico fue alto en Espana en el periodo del bono demografico",
      ...
      series: [
        {
          ...
          type: "line",
          data: [
            6000, 8200, 10000, 12000, 14500, 15000, 14800, 15100, 16000, 19000,
            20500, 22000, 24000, 25500, 26500, 27000, 26000, 25000, 26500,
            27500, 24500, 28000,
          ],
          color: "#7f5b00",
          smooth: true,
    ...
    f10: {
      title:
        "Grafico 8. La productividad laboral se estanco en Espana en el periodo del bono demografico",
      ...
      series: [
        {
          ...
          type: "line",
          data: [
            5.2, 6.3, 7.0, 8.9, 13.0, 17.0, 21.0, 25.0, 29.0, 33.0, 37.0, 40.0,
            41.0, 42.0, 43.8, 44.1, 44.0, 44.1, 44.3, 44.6, 45.3, 46.5, 47.2,
            47.8,
          ],
          color: "#7f5b00",
          smooth: true,
    ...
    f11: {
      ...
      subtitle:
        "Porcentaje de la poblacion con una pension de vejez/supervivencia y de incapacidad en Europa",
      source: "Eurostat",
      sourceUrl:
        "https://hesperides.edu.es/documentos_pdf/Informe_dia_D_pensiones.pdf",
      exactness: "reconstruida visualmente",
    ...
    f14: {
      title:
        "Grafico 12. El sistema de pensiones de Espana es de los mas generosos de Europa",
    ...
    f15: {
      title:
        "Grafico 13. Espana soporta mayores impuestos al trabajo que Europa y la OCDE",
      subtitle:
        "Cuña fiscal al trabajo en Espana, Union Europea y OCDE (2000-2024)",
      ...
      series: [
        {
          ...
          type: "line",
          data: [
            37.2, 37.5, 37.9, 37.1, 37.4, 37.6, 37.8, 37.0, 36.2, 36.6, 38.5,
            39.2, 39.3, 39.4, 38.0, 37.8, 37.7, 37.8, 37.9, 37.2, 36.9, 37.8,
            38.2, 39.0, 39.5,
          ],
          color: "#f3c400",
          smooth: true,
        ...
        },
        {
          ...
          type: "line",
          data: [
            41.2, 40.6, 40.1, 39.7, 39.2, 39.1, 38.8, 38.2, 37.8, 37.2, 38.1,
            38.8, 39.2, 39.1, 38.9, 38.4, 38.0, 37.8, 37.7, 37.6, 37.4, 37.2,
            37.3, 37.5, 37.6,
          ],
          color: "#9b7700",
        ...
        },
        {
          ...
          type: "line",
          data: [
            33.8, 33.5, 33.3, 33.1, 32.9, 32.8, 32.6, 32.4, 32.0, 31.7, 31.9,
            32.1, 32.2, 32.0, 31.8, 31.7, 31.6, 31.5, 31.3, 31.2, 30.9, 31.1,
            31.2, 31.3, 31.3,
          ],
          color: "#6b4a00",
          lineStyle: { type: "dashed", width: 2 },
    ...
    f16: {
      title:
        "Grafico 14. Espana cuenta con 2,3 trabajadores por cada pensionista",
    ...
    f17: {
      title:
        "Grafico 15. La sostenibilidad del sistema de pensiones se ve perjudicada por un mercado de trabajo disfuncional",
      ...
      series: [
        {
          ...
          type: "line",
          data: [
            1.3, 1.0, 0.8, 0.7, 1.0, 2.0, 3.0, 5.0, 8.0, 12.0, 16.0, 21.1, 19.0,
            16.1, 20.0, 23.8, 22.0, 19.0, 15.0, 12.5, 11.0, 10.0, 8.3, 8.7,
            18.0, 22.0, 25.8, 21.0, 16.0, 13.0, 14.5, 11.4,
          ],
          color: "#f3c400",
          areaStyle: 0.16,
          smooth: true,
    ...
    f18: {
      title:
        "Grafico 16. La proporcion de personas trabajando en Espana es de las mas bajas de Europa",
      subtitle:
        "Porcentaje de poblacion empleada sobre la poblacion de 20 a 64 anos (ano 2024)",
      source: "Eurostat",
      sourceUrl:
        "https://hesperides.edu.es/documentos_pdf/Informe_dia_D_pensiones.pdf",
      exactness: "reconstruida visualmente",
    ...
    f19: {
      title:
        "Grafico 17. Las pensiones se disparan en Espana mientras los salarios se estancan",
      ...
      series: [
        {
          ...
          smooth: false,
          data: [
            0.0, 0.5, -1.2, -2.5, -5.4, -5.0, -4.2, -4.0, -5.0, -4.1, -3.8,
            -3.5, -1.9, 1.8, -3.2, -2.3,
          ],
          color: "rgba(0,0,0,0)",
          symbol: "none",
        ...
        },
        {
          ...
          smooth: false,
          data: [
            0.0, 1.6, 5.7, 7.5, 11.7, 13.7, 16.4, 18.8, 20.6, 20.8, 21.3, 22.3,
            24.5, 24.4, 24.2, 30.9,
          ],
          color: "rgba(0,0,0,0)",
          symbol: "none",
        ...
        },
        {
          ...
          type: "line",
          data: [
            0.0, 2.1, 4.5, 5.0, 6.3, 8.7, 12.2, 14.8, 15.6, 16.7, 17.5, 18.8,
            22.6, 26.2, 21.0, 28.6,
          ],
          color: "#f3c400",
          smooth: false,
    ...
    f20: {
      ...
      subtitle:
        "Ingreso antes y despues de la redistribucion del Estado (ano 2022)",
    ...
    f21: {
      title:
        "Tabla 3. Espana: porcentaje de personas por grupo etario que no pueden permitirse...",
    ...
    f22: {
      ...
      subtitle:
        "Tasa de reemplazo (1985 vs 2025) segun anos cotizados y revalorizacion anual",
    ...
    f23: {
      title:
        "Grafico 20. La rentabilidad de la inversion en la Seguridad Social se desploma",
      subtitle:
        "Rentabilidad (TIR) de la inversion en el sistema de pensiones en Espana (1985 vs 2025)",
      source: "Elaboracion propia",
      sourceUrl:
        "https://hesperides.edu.es/documentos_pdf/Informe_dia_D_pensiones.pdf",
      exactness: "reconstruida visualmente",
  ...
  window.REPORT_DATA = {
    meta: {
      ...
      lead: "Version interactiva del informe con graficos y tablas reconstruidos visualmente para explorar la transicion demografica y su impacto fiscal.",
      ...
      keyFinding: {
        kpi: "1,12",
        text: "Tasa de fertilidad — la mitad del nivel de reemplazo generacional",
      },
      contentBadge: "20 graficos · 3 tablas",
    },
    metrics: [
      { kpi: "1,12", label: "Tasa de fertilidad (2023)" },
      { kpi: "2,3:1", label: "Ratio cotizantes por pensionista" },
      { kpi: "12,7M", label: "Baby boomers acercandose a jubilacion" },
    ...
    chapters: [
      ...
      },
      {
        id: "sec-3",
        title:
          "3. El desajuste en el sistema de pensiones ocurre antes de tiempo",
        charts: makeIds("f", 11, 18),
      },
      {
        id: "sec-4",
        title: "4. La amarga guerra intergeneracional en España",
        charts: makeIds("f", 19, 23),
      },
    ...
    playgrounds: [
      {
        ...
        compute: (state, h) => {
          ...
          const ratioCotizantes = h.clamp(
            2.1 -
              (gasto2050 - 12.2) * 0.09 +
              (state.tasa_empleo - 74) * 0.01 +
              (state.edad_efectiva - 64.9) * 0.04,
            1.3,
            2.4,
          );

          const brecha2050 = h.clamp(
            -4.5 - (gasto2050 - 14.9) * 0.65,
            -7.2,
            -2.5,
          );
          ...
          return {
            kpis: [
              {
                value: `${h.formatNumber(gasto2050, 2)}% PIB`,
                desc: "Gasto en pensiones estimado en 2050",
              },
              {
                value: `${h.formatNumber(ratioCotizantes, 2)}`,
                desc: "Cotizantes por pensionista (proxy)",
                color,
              },
              {
                value: `${h.formatNumber(brecha2050, 2)}% PIB`,
                desc: "Brecha de financiacion estimada en 2050",
              },
              {
                value: `${h.formatNumber(presion, 2)} p.p.`,
                desc: "Desviacion frente al escenario base 2050",
              },
            ],
            thermometer: {
              value: senal,
            ...
            narrative: narrativa,
            note: "La relacion cotizantes/pensionista se usa como aproximacion de equilibrio y no como proyeccion demografica completa.",
          };
        },
      },
      {
        ...
        compute: (state, h) => {
          ...
          const ajustePendiente = Math.max(
            0,
            1.0 - Math.min(1, impacto / brechaBase),
          );
          const gastoAjustado = h.clamp(
            14.9 -
              state.retraso_jubilacion * 0.25 -
              state.ajuste_revalorizacion * 0.4,
            12.5,
            15.2,
          );
          const transferenciasEquivalentes = Math.max(
            0,
            (-brechaResidual * 1742263) / 100,
          );
          ...
          return {
            kpis: [
              {
                value: `${h.formatNumber(brechaResidual, 2)}% PIB`,
                desc: "Brecha residual estimada en 2050",
                color,
              },
              {
                value: `${h.formatNumber(impacto, 2)} p.p.`,
                desc: "Impacto agregado de las palancas",
              },
              {
                value: `${h.formatNumber(gastoAjustado, 2)}% PIB`,
                desc: "Gasto 2050 tras ajustes de parametros",
              },
              {
            ...
            narrative: narrativa,
            note: "La conversion a millones usa PIB de referencia constante para facilitar comparabilidad entre escenarios.",
          };
        },
      },
    ],
